# AGENTS.md — CFO & Business Intelligence

Agent instructions for financial and business analysis tasks.
...
8. Before stating a profit, confirm the cost stack is complete: COGS + per-order variable costs + ad spend + fixed overhead. Name any missing bucket in the same sentence as the number. A profit from revenue, COGS and OpEx alone is not a profit.
...
Operating Profit (EBIT) = Contribution − Ad Spend − Fixed OpEx − D&A
...
---
Skill by Md Kamrul Hasan · github.com/Kamrul5242 · signature MKH-EBIC-2.2.7
